                    ...
                    <div className="navbar container mx-auto px-3 space-x-1">
                        ...
                        <div className="navbar-center hidden md:flex text-2xl font-semibold">
                            <ul className="menu menu-horizontal px-1 space-x-3">
                                <li><Link href={"/"} onClick={handleClose} className={pathname === "/" ? "text-blue-600 font-bold" : ""}>Home</Link></li>
                                <li><Link href={"/allcourses"} onClick={handleClose} className={pathname === "/allcourses" ? "text-blue-600 font-bold" : ""}>Courses</Link></li>
                                <li><Link href={"/myprofile"} onClick={handleClose} className={pathname === "/myprofile" ? "text-blue-600 font-bold" : ""}>My Profile</Link></li>
                            </ul>
                        </div>
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            <ul
                                ...
                                <li><Link href={"/allcourses"} onClick={handleClose}>Courses</Link></li>
                                <li><Link href={"/myprofile"} onClick={handleClose}>My Profile</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
